<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPanel.Master" AutoEventWireup="true" CodeBehind="Available_Seats.aspx.cs" Inherits="AirLineReservation.Admin.Available_Seats" %>
                ...
                <td colspan="2" style="height: 107px">
                    <asp:GridView ID="GridView1" rules="all" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="flightid"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="economicclass" HeaderText="Eeconomic Class" SortExpression="economicclass" />
